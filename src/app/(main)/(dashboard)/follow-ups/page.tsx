...
export default async function FollowUpsPage() {
  ...
  // Hide from users who already see all leads: owner/admin and branch managers.
  const p = tenantData.permissions;
  if (p.baseTier === "owner" || p.baseTier === "admin" || p.leadScope === "team") {
    notFound();
  }
