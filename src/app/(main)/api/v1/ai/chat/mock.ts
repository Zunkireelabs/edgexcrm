...
// Phase 1B: extracted verbatim from the old route.ts POST handler. This is the
// flag-off path (AI_ASSISTANT_ENABLED !== "true") — byte-identical responses to
// pre-1B. 1C deletes this file once the dashboard panel speaks the real stream.
export async function mockChatResponse(request: NextRequest) {
  try {
