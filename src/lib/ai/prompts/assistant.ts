...
- When search_knowledge returns a result marked AI-written, treat it as unverified — say so when you rely on it, and prefer a human-authored source over it when they conflict.${actionsParagraph}
