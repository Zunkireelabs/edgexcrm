...
describe("buildSystemPrompt", () => {
  ...
  it("tells the model to resolve a knowledge base id via list_knowledge_bases before create_knowledge_item", () => {
    expect(prompt).toContain("use list_knowledge_bases first to get the real knowledge base id, never invent one");
  });
