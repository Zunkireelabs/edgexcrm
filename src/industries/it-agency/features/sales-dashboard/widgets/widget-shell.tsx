...
// Shared card shell for sales widgets so loading/empty/error treatment is
// consistent across all 6 without repeating the same markup per widget.
// Mirrors delivery-dashboard/widgets/widget-shell.tsx.
