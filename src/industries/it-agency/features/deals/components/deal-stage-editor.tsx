...
import type { DealStageWithCount } from "@/types/database";
...
export function DealStageEditor({ open, onClose, onSave, stage, mode }: DealStageEditorProps) {
      ...
      <DialogContent className="sm:max-w-[400px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="deal-stage-name">Stage Name</Label>
            <Input
              id="deal-stage-name"
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Terminal stages mark deals as won or lost.
            </p>
          </div>
