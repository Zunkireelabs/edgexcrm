...
interface CreateDealPipelineModalProps {
  open: boolean;
...
export function CreateDealPipelineModal({ open, onClose, pipelines }: CreateDealPipelineModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Create Deal Pipeline</DialogTitle>
        </DialogHeader>

        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="deal-pipeline-name">Pipeline Name</Label>
            <Input
              id="deal-pipeline-name"
