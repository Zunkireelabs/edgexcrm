...
> **Status (2026-09-04):** Not started. The app still deploys as Docker + Traefik on the
> Zunkiree VPS. Authored 2026-07-02 on the unmerged `docs/organize-and-architecture-register`;
> restored 2026-09-04.
