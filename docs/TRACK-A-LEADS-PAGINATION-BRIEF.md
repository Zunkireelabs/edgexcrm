...
> **Status (2026-09-04):** Partially overtaken. The `/leads` list table + Kanban are now
> server-paginated (`getLeadsPage`, migration 194). Still open: `leads-organise` and Contacts
> remain full-load (`getLeads(..., limit: 50000)`) — tracked as open PR #33. Authored
> 2026-07-02 on the unmerged `docs/organize-and-architecture-register`; restored 2026-09-04.
