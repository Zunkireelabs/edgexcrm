...
> **Provenance note (2026-09-04):** Authored 2026-07-02 on the unmerged branch
> `docs/organize-and-architecture-register`; restored to the repo 2026-09-04 during a branch
> audit. Content is unchanged from 2026-07-02 — treat the decision as of that date and
