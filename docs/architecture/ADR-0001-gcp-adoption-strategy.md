...
> **Provenance note (2026-09-04):** Authored 2026-07-02 on the branch
> `docs/organize-and-architecture-register`, which never merged. Restored to the repo
> 2026-09-04 during a branch audit — this file previously existed nowhere on `stage` or
> `main` despite being referenced elsewhere as ACCEPTED. Content below is unchanged from
> 2026-07-02; treat the decisions as of that date and re-validate before acting on them.
